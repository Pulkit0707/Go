...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\fGreetService\x12?\n" +
	"\bSayHello\x12\x16.greet_service.NoParam\x1a\x1b.greet_service.HelloReponse\x12R\n" +
	"\x17SayHelloServerStreaming\x12\x18.greet_service.NamesList\x1a\x1b.greet_service.HelloReponse0\x01\x12U\n" +
	"\x17SayHelloClientSteeaming\x12\x1b.greet_service.HelloRequest\x1a\x1b.greet_service.MessagesList(\x01\x12^\n" +
	"\x1eSayHelloBidirectionalStreaming\x12\x1b.greet_service.HelloRequest\x1a\x1b.greet_service.HelloReponse(\x010\x01B\tZ\a./protob\x06proto3"
...
var file_proto_greet_proto_goTypes = []any{
	...
	(*HelloReponse)(nil), // 1: greet_service.HelloReponse
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	2, // 2: greet_service.GreetService.SayHelloClientSteeaming:input_type -> greet_service.HelloRequest
	2, // 3: greet_service.GreetService.SayHelloBidirectionalStreaming:input_type -> greet_service.HelloRequest
	1, // 4: greet_service.GreetService.SayHello:output_type -> greet_service.HelloReponse
	1, // 5: greet_service.GreetService.SayHelloServerStreaming:output_type -> greet_service.HelloReponse
	4, // 6: greet_service.GreetService.SayHelloClientSteeaming:output_type -> greet_service.MessagesList
	1, // 7: greet_service.GreetService.SayHelloBidirectionalStreaming:output_type -> greet_service.HelloReponse
